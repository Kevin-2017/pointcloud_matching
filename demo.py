...
print(f"RANSAC Fitness: {est_result01.fitness:.2f}")
print(f"RANSAC RMSE: {est_result01.inlier_rmse:.4f}")

# Set up offscreen rendering for the first visualization
vis = o3d.visualization.Visualizer()
vis.create_window(visible=False)  # Set to False for offscreen
vis.add_geometry(pcd0)
vis.add_geometry(pcd1)
vis.poll_events()
vis.update_renderer()
vis.capture_screen_image("./original_point_clouds.png")
vis.destroy_window()
...
# Set up offscreen rendering for the second visualization after transformation
vis = o3d.visualization.Visualizer()
vis.create_window()  # Set to False for offscreen
vis.add_geometry(pcd0)  # pcd0 is now transformed
vis.add_geometry(pcd1)
vis.poll_events()
vis.update_renderer()
vis.capture_screen_image("./transformed_point_cloud.png")
vis.destroy_window()
